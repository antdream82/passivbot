...
pub struct Analysis {
    ...
    pub wallet_exposure_mean_long: f64,
    pub wallet_exposure_max_long: f64,
    pub wallet_exposure_mean_short: f64,
    pub wallet_exposure_max_short: f64,
...
impl Default for Analysis {
    fn default() -> Self {
        Analysis {
            ...
            wallet_exposure_mean_long: 0.0,
            wallet_exposure_max_long: 0.0,
            wallet_exposure_mean_short: 0.0,
